...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Senako Consulting Services — HR consulting, trucking logistics, and farming solutions across South Africa." },
      { name: "author", content: "Senako Consulting Services" },
